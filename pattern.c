...
long stride; ///< stride to be used with the shift and groupshift patterns
long group_size; ///< group size to be used with the groupshift pattern
...
/**
* Calculates the destination using a simple shift operation.
*
* @param node The source node.
* @param nnodes Total number of Nodes.
* @return The destination node.
*/
long shift(long node, long nnodes) {
	return (node+stride)%nnodes;
}
