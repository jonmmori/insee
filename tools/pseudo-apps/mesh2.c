...
*
*@brief	This file creates a neighbor communication in a 2D Mesh towards X & Y.
*/
...
*/
void mesh2d(long nodes, long size)
{
	long dist;	///< nodes ^ 1/2
...
int main(int argc, char *argv[])
{
	...
	if (DIMEMAS_HEADER_NEEDED != 0){
		printf("#DIMEMAS:mesh2d_%d_%d:0:%d(1",nodes,size,nodes);
		for (i=1; i<nodes; i++)
			printf(",1");
		printf("),0\n");
	}
